...
export default function RegisterButton() {
  ...
  return (
    <motion.button
      ...
      className="relative h-10 border border-[#5256a2] flex overflow-hidden bg-slate-100 py-1 gap-2 pr-4 pl-2 shadow-md text-md text-black rounded-full uppercase font-medium leading-loose poppins"
    >
      <motion.div
