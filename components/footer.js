          ...
          <div className="flex justify-between md:flex-row flex-col gap-8 w-[70%]">
            <div className="">
              ...
              <ul className=" content-evenly text-base font-medium">
                ...
                <li>
                  <Link href="https://instagram.com/ieee_csmuj?igshid=OGQ5ZDc2ODk2ZA==" className="inline-flex">
                ...
                <li>
                  <Link href="https://chat.whatsapp.com/GHqC5oT8x0w6ogNy94fhuI" className="inline-flex">
