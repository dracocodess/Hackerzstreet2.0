...
export default function Hero() {
    ...
    return (
        <div
            ...
            />
            <div className="block text-wrap break-words px-8 py-12 mt-5">
                <Image src="/assets/ieee-logo-white.svg" alt="logo" className="w-64 md:w-72 mb-10" width={1960}
                       height={1080}/>
                <span id="typewriter" className="text-[#d6d5e3] lg:text-[4rem] md:text-3xl text-3xl font-bold poppins"></span>
