...
export default function Tracks() {
    ...
    return <motion.div
        ...
        from-lime-500 to-lime-400 py-10 -z-10">
        <div className="overflow-hidden w-fit mx-auto relative rounded-md m-10 px-2">
            ...
            <h1 className="text-6xl font-bold poppins text-center mx-auto bg-gradient-to-r ease-in-out via-red-400 bg-clip-text text-transparent
            from-orange-400 to-orange-500
            animate-text z-10">{t('Tracks')}</h1>
        </div>
        <div className="h-2"/>
        <h2 className="text-center mx-auto font-bold text-xl poppins text-orange-400">{t('Our tracks')}</h2>
        <div className="h-10"/>
